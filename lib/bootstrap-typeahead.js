...
function ($) {
    ...
    var Typeahead = function (element, options) {
        ...
        this.$result    = $(this.options.result_id);
        this.type       = this.options.type;
        //this.listAdd    = this.options.listAdd || this.listAdd;
        //this.listRemove = this.options.listRemove || this.listRemove;
    ...
    Typeahead.prototype = {
        ...
        listen: function () {
            ...
            //this.$result.on('click', '.close', $.proxy(this.click, this))
        },
        ...
        add: function() {
            ...
            if(this.type !== 'undefined'){
                var $selectedItem = this.$menu.find('.active');
                var item = $(this.options.listItem);
                item.data('value', $selectedItem.data('value'));

                if (this.type === 'single'){
                    this.$result.html(item);
                }else{
                    item.append($selectedItem.text());
                }
                listAdd(item.data('value'),item.data('text'));
            }
        },
        ...
        close: function(e) {
            ...
            id   = $(e.currentTarget).data('value');
            name = $(e.currentTarget).text();

            $(e.currentTarget).parents('[data-list-container=true]').remove();
            
            this.listRemove(id, name);
        }
    }
    ...
    $.fn.typeahead.defaults = {
        ...
        item: '<li><a href="#"></a></li>',
        listItem: '<li data-list-container=true><a href="#"></a><span class="close"></span></li>',
        display: 'name',
        val: 'id',
