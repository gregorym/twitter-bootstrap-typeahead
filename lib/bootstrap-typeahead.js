...
function ($) {
    ...
    var Typeahead = function (element, options) {
        ...
        this.$result    = $(this.options.result_id).addClass('typeahead').addClass('result');
    ...
    Typeahead.prototype = {
        ...
        render: function (items) {
            ...
            items = $(items).map(function (i, item) {
                ...
                if (that.options.displayMatch) {
                    var info = $('<span>');
                    i.find('a').html(item[that.options.display]);
                    i.append('Matched: ' + that.highlighter(item[that.options.display]));
                }else{
        ...
        add: function() {
            if(this.type !== 'undefined'){
                ...
                item.html($selectedItem.text()+"<span class='close'>Close</span>");
